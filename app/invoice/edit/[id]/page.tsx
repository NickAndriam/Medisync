...
const Edit = () => {
  ...
  return (
    <main className="relative lg:pl-56 pt-20 overflow-y-scroll lg:h-screen h-full bg-base-content w-full flex lg:flex-row flex-col">
      <div className="relative bg-base-content w-full lg:w-[60%] h-full overflow-y-scroll">
        <section className="relative px-10 py-8 flex flex-col gap-y-4">
          <h2 className="text-gray-500 text-xl font-bold mb-2">Edit Invoice</h2>
          <div>
            <IDResult />
          </div>
          {/* --------------------------
